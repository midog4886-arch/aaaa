...
export const socialAPI = {
  ...
  previewVideo: (data) => axios.post(`${API}/social/posts/preview`, data),
  ...
  getUploadsCleanupRuns: (limit = 50) =>
    axios.get(`${API}/social/uploads-cleanup-runs`, { params: { limit } }),
...
export const notificationsSettingsAPI = {
  ...
  updateDailyChecks: (hour, minute = 0, daysOfWeek) => axios.put(
    `${API}/notifications/daily-checks-settings`,
    daysOfWeek === undefined || daysOfWeek === null
      ? { hour, minute }
      : { hour, minute, days_of_week: daysOfWeek },
  ),
...
export const whatsappAPI = {
  ...
  getWelcomeTemplate: () =>
    axios.get(`${API}/whatsapp/welcome-template`),
