    ...
    printWindow.document.write(`<!DOCTYPE html><html><head><meta charset="UTF-8"><title>CD820 - ${member?.member_code}</title>
      <style>
        ...
        * { margin:0; padding:0; box-sizing:border-box; }
        ...
        .card { width:54mm; height:85.6mm; display:flex; flex-direction:column; position:relative; padding-top:5mm; }
        .accent-stripe { position:absolute; top:5mm; bottom:0; right:0; width:4mm; background:linear-gradient(180deg,#0B1F3A 0%,#1E3A5F 35%,#C9A227 78%,#F5C842 100%); z-index:2; }
        ...
        .schedule-info { text-align:center; font-size:5pt; color:${_accent}; margin-top:0.3mm; font-weight:700; background:#FFF7ED; padding:0.3mm 0.8mm; border-radius:1.2mm; }
        .info-label { color:#6b7280; font-size:6pt; font-weight:600; }
