    ...
    printWindow.document.write(`<!DOCTYPE html><html><head><meta charset="UTF-8"><title>CD820 - ${member?.member_code}</title>
      <style>
        ...
        * { margin:0; padding:0; box-sizing:border-box; }
        ...
        .accent-stripe { position:absolute; top:5mm; bottom:1mm; right:1mm; width:5mm; background:linear-gradient(180deg,#0B1F3A 0%,#1E3A5F 35%,#C9A227 78%,#F5C842 100%); z-index:2; border-radius:1mm; }
