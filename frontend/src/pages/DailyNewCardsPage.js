    ...
    win.document.write(`<!DOCTYPE html><html><head><meta charset="UTF-8"><title>كروت ${data.date}</title>
      <style>
        ...
        * { margin:0; padding:0; box-sizing:border-box; }
        ...
        .header-logo img { width:140%; height:140%; object-fit:cover; border-radius:50%; transform:scale(1); }
    ...
    win.document.write(`<!DOCTYPE html><html><head><meta charset="UTF-8"><title>CD820 - ${data.date}</title>
      <style>
        ...
        * { margin:0; padding:0; box-sizing:border-box; }
        ...
        .logo-card { width:85.6mm; height:54mm; background:white; display:flex; flex-direction:column; align-items:center; justify-content:center; padding:1.5mm; border:none; border-radius:0; }
