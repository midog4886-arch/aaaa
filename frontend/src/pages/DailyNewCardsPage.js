    ...
    win.document.write(`<!DOCTYPE html><html><head><meta charset="UTF-8"><title>CD820 - ${data.date}</title>
      <style>
        ...
        * { margin:0; padding:0; box-sizing:border-box; }
        ...
        .card { width:54mm; height:85.6mm; border-radius:0; border:none; display:flex; flex-direction:column; position:relative; padding:5mm 3mm 3mm 3mm; box-sizing:border-box; }
