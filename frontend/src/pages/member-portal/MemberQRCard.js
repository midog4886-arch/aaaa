            ...
            <div className="py-4">
              ...
              <div className="bg-gray-100 p-4 rounded-lg">
                <div className="flex gap-3 justify-center max-w-[360px] mx-auto">
                  ...
                  <div className="aspect-[9/7] w-[140px] bg-white border-2 border-blue-400 rounded-lg flex flex-col items-center justify-center gap-2 p-3">
                  ...
                  <div className="aspect-[9/7] w-[140px] bg-white border-2 border-blue-400 rounded-lg flex flex-col items-center justify-center gap-2 p-3 overflow-hidden">
                    <img 
