...
const translations = {
  ar: {
    ...
    coach_salaries: 'رواتب وسُلف المدربين',
    ...
    rentals: 'تأجير الساعات',
    day_extensions: 'ترحيل الأيام',
    messages: 'الرسائل',
    settings: 'الإعدادات',
    backup: 'النسخ الاحتياطي',
    audit_log: 'سجل التدقيق',
    operation_passwords: 'كلمات مرور العمليات',
    ops_alerts: 'تنبيهات النظام',
  ...
  en: {
    ...
    rentals: 'Hour Rentals',
    day_extensions: 'Day Extensions',
    messages: 'Messages',
    settings: 'Settings',
    backup: 'Backup',
    audit_log: 'Audit Log',
    operation_passwords: 'Operation Passwords',
    ops_alerts: 'System Alerts',
    ...
    coach_salaries: 'Coach Salaries & Advances',
