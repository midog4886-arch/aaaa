...
5. **الساعة** - حقل نصي يدوي (مثال: 4:00 م)
6. **المستوى** - قائمة متسلسلة مع شريط التعبئة (نشاط ← وقت ← مستوى)

#### الملفات المُحدثة:
- `/app/frontend/src/pages/MembersPage.js`
  - إعادة هيكلة قسم النشاط ليكون مطابق للفواتير
  - أيام التدريب بالعربية الكاملة
  - حقل الساعة نصي (بدلاً من رقم + صباحاً/مساءً)
  - تنسيق الجدول الزمني مثل الفواتير
